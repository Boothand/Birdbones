...
code
proc FX_BowcasterProjectileThink 16 12
file "../fx_bowcaster.c"
line 12
;1:// Bowcaster Weapon
;2:
...
;5:/*
;6:---------------------------
;7:FX_BowcasterProjectileThink
;8:---------------------------
;9:*/
;10:
;11:void FX_BowcasterProjectileThink( centity_t *cent, const struct weaponInfo_s *weapon )
;12:{
line 15
;13:	vec3_t forward;
;14:
...
line 20
;19:
;20:	trap_FX_PlayEffectID( cgs.effects.bowcasterShotEffect, cent->lerpOrigin, forward );
...
;21:}
LABELV $120
endproc FX_BowcasterProjectileThink 16 12
export FX_BowcasterHitWall
proc FX_BowcasterHitWall 0 12
line 30
;22:
;23:/*
;24:---------------------------
;25:FX_BowcasterHitWall
;26:---------------------------
;27:*/
;28:
;29:void FX_BowcasterHitWall( vec3_t origin, vec3_t normal )
;30:{
line 31
;31:	trap_FX_PlayEffectID( cgs.effects.bowcasterImpactEffect, origin, normal );
...
;32:}
LABELV $126
endproc FX_BowcasterHitWall 0 12
export FX_BowcasterHitPlayer
proc FX_BowcasterHitPlayer 0 12
line 41
;33:
;34:/*
;35:---------------------------
;36:FX_BowcasterHitPlayer
;37:---------------------------
;38:*/
;39:
;40:void FX_BowcasterHitPlayer( vec3_t origin, vec3_t normal, qboolean humanoid )
;41:{
line 42
;42:	trap_FX_PlayEffectID( cgs.effects.bowcasterImpactEffect, origin, normal );
ADDRGP4 cgs+71560+72
INDIRI4
ARGI4
ADDRFP4 0
...
;43:}
LABELV $129
endproc FX_BowcasterHitPlayer 0 12
export FX_BowcasterAltProjectileThink
proc FX_BowcasterAltProjectileThink 16 12
line 52
;44:
;45:/*
;46:------------------------------
;47:FX_BowcasterAltProjectileThink
;48:------------------------------
;49:*/
;50:
;51:void FX_BowcasterAltProjectileThink( centity_t *cent, const struct weaponInfo_s *weapon )
;52:{
line 55
;53:	vec3_t forward;
;54:
;55:	if ( VectorNormalize2( cent->currentState.pos.trDelta, forward ) == 0.0f )
ADDRFP4 0
INDIRP4
CNSTI4 36
ADDP4
...
line 60
;59:
;60:	trap_FX_PlayEffectID( cgs.effects.bowcasterShotEffect, cent->lerpOrigin, forward );
ADDRGP4 cgs+71560+68
INDIRI4
ARGI4
ADDRFP4 0
...
;61:}
LABELV $132
endproc FX_BowcasterAltProjectileThink 16 12
