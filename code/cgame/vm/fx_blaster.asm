export FX_BlasterProjectileThink
code
proc FX_BlasterProjectileThink 16 12
file "../fx_blaster.c"
line 12
;1:// Blaster Weapon
;2:
...
;5:/*
;6:-------------------------
;7:FX_BlasterProjectileThink
;8:-------------------------
;9:*/
;10:
;11:void FX_BlasterProjectileThink( centity_t *cent, const struct weaponInfo_s *weapon )
;12:{
line 15
;13:	vec3_t forward;
;14:
...
line 20
;19:
;20:	trap_FX_PlayEffectID( cgs.effects.blasterShotEffect, cent->lerpOrigin, forward );
...
;21:}
LABELV $120
endproc FX_BlasterProjectileThink 16 12
export FX_BlasterAltFireThink
proc FX_BlasterAltFireThink 16 12
line 29
;22:
;23:/*
;24:-------------------------
;25:FX_BlasterAltFireThink
;26:-------------------------
;27:*/
;28:void FX_BlasterAltFireThink( centity_t *cent, const struct weaponInfo_s *weapon )
;29:{
line 32
;30:	vec3_t forward;
;31:
...
line 37
;36:
;37:	trap_FX_PlayEffectID( cgs.effects.blasterShotEffect, cent->lerpOrigin, forward );
ADDRGP4 cgs+71560+28
INDIRI4
ARGI4
ADDRFP4 0
...
;38:}
LABELV $126
endproc FX_BlasterAltFireThink 16 12
export FX_BlasterWeaponHitWall
proc FX_BlasterWeaponHitWall 0 12
line 46
;39:
;40:/*
;41:-------------------------
;42:FX_BlasterWeaponHitWall
;43:-------------------------
;44:*/
;45:void FX_BlasterWeaponHitWall( vec3_t origin, vec3_t normal )
;46:{
line 47
;47:	trap_FX_PlayEffectID( cgs.effects.blasterWallImpactEffect, origin, normal );
...
;48:}
LABELV $132
endproc FX_BlasterWeaponHitWall 0 12
export FX_BlasterWeaponHitPlayer
proc FX_BlasterWeaponHitPlayer 0 12
line 56
;49:
;50:/*
;51:-------------------------
;52:FX_BlasterWeaponHitPlayer
;53:-------------------------
;54:*/
;55:void FX_BlasterWeaponHitPlayer( vec3_t origin, vec3_t normal, qboolean humanoid )
;56:{
line 57
;57:	if ( humanoid )
ADDRFP4 8
...
;58:	{
line 59
;59:		trap_FX_PlayEffectID( cgs.effects.blasterFleshImpactEffect, origin, normal );
...
;62:	{
line 63
;63:		trap_FX_PlayEffectID( cgs.effects.blasterDroidImpactEffect, origin, normal );
...
;65:}
LABELV $135
endproc FX_BlasterWeaponHitPlayer 0 12
