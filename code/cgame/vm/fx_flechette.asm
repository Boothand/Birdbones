export FX_FlechetteProjectileThink
code
proc FX_FlechetteProjectileThink 16 12
file "../fx_flechette.c"
line 12
;1:// Golan Arms Flechette Weapon
;2:
;3:#include "cg_local.h"
;4:
;5:/*
;6:-------------------------
;7:FX_FlechetteProjectileThink
;8:-------------------------
;9:*/
;10:
;11:void FX_FlechetteProjectileThink( centity_t *cent, const struct weaponInfo_s *weapon )
;12:{
line 15
;13:	vec3_t forward;
;14:
...
line 20
;19:
;20:	trap_FX_PlayEffectID( cgs.effects.flechetteShotEffect, cent->lerpOrigin, forward );
...
;21:}
LABELV $120
endproc FX_FlechetteProjectileThink 16 12
export FX_FlechetteWeaponHitWall
proc FX_FlechetteWeaponHitWall 0 12
line 29
;22:
;23:/*
;24:-------------------------
;25:FX_FlechetteWeaponHitWall
;26:-------------------------
;27:*/
;28:void FX_FlechetteWeaponHitWall( vec3_t origin, vec3_t normal )
;29:{
line 30
;30:	trap_FX_PlayEffectID( cgs.effects.flechetteWallImpactEffect, origin, normal );
...
;31:}
LABELV $126
endproc FX_FlechetteWeaponHitWall 0 12
export FX_FlechetteWeaponHitPlayer
proc FX_FlechetteWeaponHitPlayer 0 12
line 39
;32:
;33:/*
;34:-------------------------
;35:FX_FlechetteWeaponHitPlayer
;36:-------------------------
;37:*/
;38:void FX_FlechetteWeaponHitPlayer( vec3_t origin, vec3_t normal, qboolean humanoid )
;39:{
line 42
;40://	if ( humanoid )
;41://	{
;42:		trap_FX_PlayEffectID( cgs.effects.flechetteFleshImpactEffect, origin, normal );
...
;44://	else
;45://	{
;46://		trap_FX_PlayEffect( "blaster/droid_impact", origin, normal );
;47://	}
;48:}
LABELV $129
endproc FX_FlechetteWeaponHitPlayer 0 12
export FX_FlechetteAltProjectileThink
proc FX_FlechetteAltProjectileThink 16 12
line 58
;49:
;50:
;51:/*
;52:-------------------------
;53:FX_FlechetteProjectileThink
;54:-------------------------
;55:*/
;56:
;57:void FX_FlechetteAltProjectileThink( centity_t *cent, const struct weaponInfo_s *weapon )
;58:{
line 61
;59:	vec3_t forward;
;60:
;61:	if ( VectorNormalize2( cent->currentState.pos.trDelta, forward ) == 0.0f )
ADDRFP4 0
INDIRP4
CNSTI4 36
ADDP4
...
line 66
;65:
;66:	trap_FX_PlayEffectID( cgs.effects.flechetteAltShotEffect, cent->lerpOrigin, forward );
...
;67:}
LABELV $132
endproc FX_FlechetteAltProjectileThink 16 12
