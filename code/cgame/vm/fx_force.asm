export FX_ForceDrained
code
proc FX_ForceDrained 12 12
file "../fx_force.c"
line 12
;1:// Any dedicated force oriented effects
;2:
...
;8:-------------------------
;9:*/
;10:// This effect is not generic because of possible enhancements
;11:void FX_ForceDrained(vec3_t origin, vec3_t dir)
;12:{
line 13
;13:	VectorScale(dir, -1.0, dir);
ADDRLP4 0
ADDRFP4 4
INDIRP4
ASGNP4
...
ASGNF4
line 14
;14:	trap_FX_PlayEffectID(cgs.effects.forceDrained, origin, dir);
